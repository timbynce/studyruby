...
class Railway
  ...
  def menu
    options = {
      ...
      '4' => proc { add_station }, '5' => proc { remove_station }, '6' => proc { to_route },
  ...
  def seed
    ...
    @stations << Station.new('Prague')

    @routes << Route.new(stations[0], stations[1])

    @trains['qwerty'] = PassTrain.new('qwerty')
    @trains['qazws'] = PassTrain.new('qazws')
  ...
  def create_train
    ...
    number = gets.chomp
    puts 'Wrong train type' unless %w[passenger cargo].include? type
  ...
  def to_route
    ...
    train_by_num(tr_num).to_route(@routes[route_index])
  rescue StandardError => e
    puts e.message
  end
  ...
  def remove_wagon
    ...
    train_by_num(tr_num).remove_carriage(wagon)
  rescue StandardError => e
    puts e.message
  end
  ...
  def create_wagon
    ...
    type = gets.chomp
    return 'Wrong type' unless %w[cargo passenger].include? type
